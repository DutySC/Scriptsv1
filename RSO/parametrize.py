...
region = 'РСО-Алании' #регион/отдельный клиент
login = 'BARS_TTEST' #логин
password = '123' #пароль
disease = 'J10.0' #диагноз при дневнике врача
patient = '170102530' #тестовый пациент
doctor = 'Тестирование П.' #врачь
department = 'Поликлиника отд' #отделение
polyclinic = '110' #кабинет
g_disease = 'Z00.0' #диагноз при госпитализации
name_patient = 'Тест Миац Авокадо Желейка' #имя тестового пациента
schedule_patient = 'Тест Миац А.Ж.' #сокращенное имя тестового пациента
...
snils = '51914689915' #статичное значение СНИЛС
position = '1'
