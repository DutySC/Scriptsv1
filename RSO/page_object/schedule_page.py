...
class locators_schedule:
    ...
    LOCATOR_FILTER_DOC = (By.XPATH, '//div[1]/div[1]//tr[3]/td[2]//input[1]')
    LOCATOR_SEARCH_1 = (By.XPATH, '//body[1]//tr[3]//td[contains(text(), "Найти")]')
    LOCATOR_CHOOSE_SCHEDULE = (By.XPATH, '//a[contains(text(), "Тестирование П.")]')
...
class schedule(BasePage):
    def patient_schedule(self):
        try:
            ...
            search_string_3 = self.find_element(locators_schedule. LOCATOR_FILTER_DOC)  # ввод врача
