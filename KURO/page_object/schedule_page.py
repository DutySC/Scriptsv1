...
class locators_schedule:
    ...
    LOCATOR_SCHEDULE_2 = (By.XPATH, '//tbody/tr[6]/td[2]/a[1]/span[1][contains(text(), "Расписание")]')
    ...
    LOCATOR_DEPARTMENT = (By.XPATH, '//body[1]//table[1]//table[1]//table[1]//a[1][contains(text(), "Взрослое поликлиническое")]')
    ...
    LOCATOR_CARD_NUMBER = (By.XPATH, '//body[1]/div[8]//div[11]//td[5]//input[1]')
    LOCATOR_SEARCH_2 = (By.XPATH, '//body[1]/div[8]//td[3]//td[contains(text(), "Найти")]')
    LOCATOR_PATIENT_ON_WRITE = (By.XPATH, f'//body[1]//tr[1]//tr[1]//a[contains(text(), "{prm.name_patient_1}")]')
    LOCATOR_PATIENT_ON_WRITE_SERVICE_1 = (By.XPATH, '//body[1]/div[8]//div[13]//tbody[1]//tbody[1]/tr[2]//img[1]')
...
class schedule(BasePage):
    def patient_schedule(self):
        try:
            ...
            self.find_element_pb() # прогрессбар
            self.find_element(locators_schedule.LOCATOR_DEPARTMENT).click() # выбрать отделение
            ...
            search_string_4.send_keys(prm.patient_1) # вввод 220000155
            ...
            self.get_screenshots('Results/KURO_sc/Расписание.png')
