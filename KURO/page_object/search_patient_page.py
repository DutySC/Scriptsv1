...
class search_patient_locators:
    ...
    LOCATOR_SEARCH_PATIENT_2 = (By.XPATH, '//tbody/tr[8]//span[1][contains(text(), "Поиск пациентов")]')
    ...
    LOCATOR_CARD_NUMBER = (By.XPATH, '//body[1]/div[7]//div[1]/div[1]/div[1]//div[1]//div[1]/div[2]//td[2]//input[1]')
    ...
    LOCATOR_CHOOSE_BAHMYTEC = (By.XPATH, '//a[contains(text(), "Бахмутец")]')
...
class search_patient(BasePage):
    def create_patient(self):
        try:
            ...
            self.get_screenshots('Results/KURO_sc/Поиск.png')
