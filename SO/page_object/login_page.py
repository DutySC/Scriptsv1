...
class login_locators:
    ...
    LOCATOR_LPU_2 = (By.XPATH, '//tbody/tr[26]//span[contains(text(), "650000")]')
    LOCATOR_LC_1 = (By.XPATH, '//div[@name="CABLAB"]/div[@class="cmbb-button"]')
    LOCATOR_LC_2 = (By.XPATH, '//span[contains(text(), "303-01")]')
    LOCATOR_ENTER_LPU = (By.XPATH, '//tr[3]/td[1]/div[1]/div[1]')
...
class login(BasePage):
    def auth(self):
        ...
        try:
            ...
            self.find_element_pb()  # прогрессбар
            self.find_element(login_locators.LOCATOR_ENTER_LPU).click() # продолжить
