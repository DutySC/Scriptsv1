...
class search_patient_locators:
    ...
    LOCATOR_INSURANCE_COMPANY_1 = (By.XPATH, '//body[1]/div[7]//tr[2]/td[1]//td[1]/div[1]//tr[4]//img[1]')
    LOCATOR_INSURANCE_COMPANY_2 = (By.XPATH, '//div[2]/div[2]//span[contains(text(), "ООО")]')
    ...
    LOCATOR_DATA_3 = (By.XPATH, '//div[7]//div[1]/div[1]/div[1]//div[1]//div[1]/div[2]//div[2]/div[1]/div[1]')
    ...
    LOCATOR_DATA_5 = (By.XPATH, '//body[1]/div[7]//td[1]/div[2]//tr[4]//div/div/div[1]')
    LOCATOR_DATA_6 = (By.XPATH, '//div[contains(text(), "Сегодня")]')
    ...
    LOCATOR_ENTER_AREA_2 = (By.XPATH, '//td[contains(text(), "Вверх")]')
    LOCATOR_ENTER_AREA_3 = (By.XPATH, '//a[contains(text(), "Адыгея")]')
    LOCATOR_ENTER_AREA_4 = (By.XPATH, '//a[contains(text(), "Адыгейск")]')
    LOCATOR_ENTER_AREA_5 = (By.XPATH, '//a[contains(text(), "Абадзехская")]')
...
class search_patient(BasePage):
    def create_patient(self):
        try:
            ...
            self.find_element(search_patient_locators.LOCATOR_INSURANCE_COMPANY_1).click()  # окно для указания страховой компании
            self.find_element_pb()  # прогрессбар
            self.find_element_pb()  # прогрессбар
            time.sleep(2)  # ожидание
            self.find_element_pb()  # прогрессбар
            self.find_element(search_patient_locators.LOCATOR_INSURANCE_COMPANY_2).click()
            ...
            self.find_element(search_patient_locators.LOCATOR_DATA_3).click()  # дата окончания
            ...
            self.find_element(search_patient_locators.LOCATOR_DATA_5).click()  # дата выдачи
            self.find_element(search_patient_locators.LOCATOR_DATA_6).click()  # указать дату выдачи
            ...
            self.find_element_pb()  # прогрессбар
            self.find_element(search_patient_locators.LOCATOR_ENTER_AREA_5).click()  # ввод адреса
            self.find_element_pb()  # прогрессбар
