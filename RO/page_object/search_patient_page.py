...
class search_patient(BasePage):
    ...
    def delete_patient(self):
        ...
        search_string_10 = self.find_element(search_patient_locators.LOCATOR_FILTER_CATALOGS_2) # фамилия
        search_string_10.send_keys(prm.last_name) # написать фамилию
        search_string_11 = self.find_element(search_patient_locators.LOCATOR_FILTER_CATALOGS_3) # имя
        search_string_11.send_keys(prm.first_name) # написать имя
        search_string_12 = self.find_element(search_patient_locators.LOCATOR_FILTER_CATALOGS_4) # отчество
        search_string_12.send_keys(prm.surname) # написать отчество
