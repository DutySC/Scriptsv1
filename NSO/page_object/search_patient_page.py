...
class search_patient_locators:
    ...
    LOCATOR_CHOOSE_ABRICOSOVOE = (By.XPATH, '//a[contains(text(), "Баган")]')
    LOCATOR_CHOOSE_VOKZALNYA = (By.XPATH, '//a[contains(text(), "Вокзальная")]')
...
class search_patient(BasePage):
    def create_patient(self):
        ...
        self.find_element_pb()  # прогрессбар
        self.find_element(search_patient_locators.LOCATOR_CHOOSE_VOKZALNYA).click()  # выбрать Вокзальная
        self.find_element_pb()  # прогрессбар
